...
The dashboard setup test expects files generated by the server-side mod. Install `@SST`, start the DayZ server once, then point the API at the generated `$storage:SST/` folder.
